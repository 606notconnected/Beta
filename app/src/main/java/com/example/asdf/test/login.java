...
public class login extends Activity {
    ...
    public static List<String> lll;//个人照片列表
...
//                System.out.println(re+"00000");
        ...
        handler1 = new android.os.Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                System.out.println(uuername+sex+introduce+"0989");
            }
        };
                        ...
                        new Thread() {
                            ...
                            public void run() {
                                ...
                                for (int i = 0; i < wat.size(); i++) {
                                    System.out.println(wat.get(i).getintroduction()+"999ljk"+wat.get(i).getaccount());
        ...
        handler7 = new android.os.Handler()
        {
            @Override
            public void handleMessage(Message msg) {
                String tmp = msg.obj.toString();
...
//                    Toast.makeText(watchFriend.this,"获取好友头像详情成功watchfroend",Toast.LENGTH_SHORT).show();
        ...
        handler6  = new android.os.Handler()
        {
            ...
            public void handleMessage(Message msg) {
                ...
                if(y.equals("true"))
                {
                    final String ss=frhe.gethead();
                    System.out.println(ss+"我的头衔名");
                    new Thread()
                    {
                        public void run()
                        {
                            myBitmap = tmp6.getBitmap("http://120.27.7.115:1010/api/image?name=" + ss, handler7);
                        }
                    }.start();
                }
                else
                {
                    System.out.println("获取my头像详情不成功");
                }
            }
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            if(account!=null&&password!=null) {
                                ...
                                tmp5.getParamTest("http://120.27.7.115:1010/api/Image_Head?account=" +account, handler6);
                            }
                        }
                    }.start();
