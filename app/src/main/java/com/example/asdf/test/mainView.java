...
public class mainView extends baseActivity implements LocationSource, AMapLocationListener {
    ...
    public static Drawable myheadDrawable;
...
//                        Toast.makeText(mainView.this, "获取行程列表成功", Toast.LENGTH_SHORT).show();
        ...
        leftDrawer.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View v) {
                                              ...
                                              if (login.myBitmap != null)
                                              {
                                                  Drawable drawable = new BitmapDrawable(toRoundBitmap(login.myBitmap));// 转换成drawable
                                                  myheadDrawable=drawable;
...
//                ;
    ...
    private void init() {
        ...
        aMap.setMapType(1);//地图风格 1水彩 2绿地 3灰色 4 灰白水泥
