...
//                    Toast.LENGTH_SHORT).show();
                    ...
                    {
                        Toast.makeText(register.this,"密码长度应该在6~16之间",Toast.LENGTH_LONG).show();
                    }
                    else if(account!=null&&phoneNumber!=null&&password!=null&&flag==0)
                    {
//                    if(resultString)
...
//                            tmp.getParamTest("http://120.27.7.115:1010/api/sign" + "?account="+account,handler);
                    ...
                    Toast.makeText(register.this, "2次输入密码不一致",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
